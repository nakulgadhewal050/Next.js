  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-black text-white px-4'>
      <div className='w-full max-w-md border border-gray-700 rounded-2xl p-8 shadow-[0_0_30px_rgba(255,255,255,0.05)] bg-gray-900'>
        <h1 className='text-3xl font-bold text-center mb-8 tracking-tight'>Login</h1>
        <form action="" className='space-y-6' onSubmit={handleSignin} >
          ...
          <p className='text-center text-sm text-gray-400 mt-4'>
            Create an account? <span onClick={() => router.push("/register")}
              className='text-blue-500 font-medium hover:underline cursor-pointer'>Register</span>
          </p>
